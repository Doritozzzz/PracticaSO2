...
SOURCES=bloques.c mi_mkfs.c ficheros_basico.c leer_sf.c ficheros.c  escribir.c leer.c permitir.c truncar.c directorios.c mi_mkdir.c mi_ls.c mi_chmod.c mi_stat.c # mi_link.c mi_escribir.c mi_cat.c  mi_rm.c semaforo_mutex_posix.c #simulacion.c verificacion.c
